...
//#region node_modules/.nitro/vite/services/ssr/assets/news-DDrd2vwP.js
...
function NewsPage() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(PageLayout, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageHeader, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "mx-auto max-w-3xl rounded-md border border-border bg-card p-8 text-center shadow-sm",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "text-base font-medium text-foreground",
				children: "No news still now."
			})
		})
	})] });
}
